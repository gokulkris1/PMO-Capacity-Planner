...
const mockAllocations = [
  ...
  { projectId: 'p1', resourceId: 'r1', percentage: 100, start_date: '2026-03-05', end_date: '2026-03-10' }
];
...
console.log("Snake Case:", res2.filter(r => r.dayOfMonth >= 4 && r.dayOfMonth <= 12).map(r => `${r.dayOfMonth}: ${r.utilization}%`));
