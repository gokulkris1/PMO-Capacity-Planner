...
export const Dashboard: React.FC<Props> = ({ resources, projects, allocations, scenarioAllocations, onTabChange, teams }) => {
    ...
    if (resources.length === 0 && projects.length === 0) {
        return (
            <div className="page-enter" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '60vh', textAlign: 'center', color: 'var(--n-600)' }}>
                <div style={{ fontSize: 48, marginBottom: 16 }}>🚀</div>
                <h2 style={{ color: 'var(--n-800)', marginBottom: 8, fontWeight: 700 }}>Welcome to your new Workspace!</h2>
                <p style={{ maxWidth: 450, lineHeight: 1.6, marginBottom: 24, color: 'var(--n-600)' }}>You don't have any resources or projects tracked yet. Get started by adding your team members and your first project initiative to see exactly where your capacity is going.</p>
